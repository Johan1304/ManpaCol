            ...
            <form action="{{route('guardar')}}" id="form-general" class="form" method='POST'>
                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                        <input class="mdl-textfield__input" value="{{old('IdTipoUsuario')}}" type="text" id="IdTipoUsuario" name="IdTipoUsuario" readonly tabIndex="-1"/>
                ...
                <div class="mdl-grid">
                    <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="text" name="name" value="{{old('name')}}" pattern="[A-Za-z]{1,45}"/>
                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="text" id="ndoc" name="NumDoc" value="{{old('NumDoc')}}" pattern="[0-9]{7,14}"/>
                ...
                <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="text" id="firstName" name="email" value="{{old('email')}}"/>
