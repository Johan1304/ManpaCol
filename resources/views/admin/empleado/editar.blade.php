...
<head>
    ...
    <title>@yield('titulo','Editar Usuario') | ManpaCol</title>
...
@include('theme/admin/asideAdm')
    ...
    <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-card mdl-shadow--2dp employer-form" action="">
            ...
            <form action="{{route('actualizar_empleado',['id'=>$empleado->id])}}" id="form-general" class="form" method='POST'>
                    @csrf
                    @method('PUT')

                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" type="text" name="Nombres" value="{{old('Nombres', $empleado->Nombres ?? '')}}" pattern="[A-Za-z]{1,45}"/>
                            <label class="mdl-textfield__label" for="firstName" requerido>Nombres</label>
                        </div>
                       
    
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" type="text" name="Apellidos" value="{{old('Apellidos', $empleado->Apellidos ?? '')}}" pattern="[A-Za-z]{1,45}"/>
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                            <input class="mdl-textfield__input" value="{{old('IdTipoDocumento', $empleado->IdTipoDocumento ?? '')}}" type="text" id="tdoc" name="IdTipoDocumento" readonly tabIndex="-1"/>
                        ...
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" type="text" id="ndoc" name="NumeroDoc" value="{{old('NumeroDoc', $empleado->NumeroDoc ?? '')}}" pattern="[0-9]{7,14}"/>
                    ...
                    <div class="form__article employer-form__general_skills">
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <textarea class="mdl-textfield__input" name="Observaciones" type="text" rows="3" id="AboutMe" maxlength="200">{{old('Nombres', $empleado->Observaciones ?? '')}}</textarea>
                                <label class="mdl-textfield__label" for="AboutMe">Observaciones</label>
                            </div>
                        </div>
                        ...
                        <div class="form__action">
                           ...
                           onclick = "this.form.action = '{{route('empleado')}}'" formmethod="GET">
                                Volver
                            </button>
