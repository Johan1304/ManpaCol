...
<head>
    ...
    <title>@yield('titulo','Editar TipoMaterial') | ManpaCol</title>
    ...
    <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-card mdl-shadow--2dp employer-form" action="">
            <div class="mdl-card__title">
                <h2>Editar Tipo Material</h2>
                <div class="mdl-card__subtitle"></div>
            </div>

            <div class="mdl-card__supporting-text">
            <form action="{{route('actualizar_tipom',['id'=>$tiposm->id])}}" class="form" method='POST'>
                @method('put')
                @csrf
                <div class="form__article">
                    ...
                    <div class="mdl-grid">
                            ...
                            <input class="mdl-textfield__input" type="text" name="Descripcion" value="{{old('Descripcion',$tiposm->Descripcion)}}"/>
                    ...
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                            <input class="mdl-textfield__input" value="{{old('IdTipoPresentacion',$tiposm->IdTipoPresentacion ?? '')}}" type="text" id="IdTipoUsuario" name="IdTipoPresentacion" readonly tabIndex="-1"/>
                            ...
                            <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu dark_dropdown" for="IdTipoUsuario">
                                @foreach ($tipopr as $presentacion)
