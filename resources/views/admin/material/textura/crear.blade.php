...
<head>
    ...
    <title>@yield('titulo','Crear Textura') | ManpaCol</title>
                ...
                <div class="form__article">
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" type="text" name="TipoPresentacion" value=""/>
                            <label class="mdl-textfield__label" for="firstName" requerido>Textura</label>
                        </div>
                    </div>
