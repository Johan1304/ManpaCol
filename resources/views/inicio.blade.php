        ...
        <div class="mdl-card mdl-card__login mdl-shadow--2dp">
                <div class="mdl-card__supporting-text color--dark-gray">
                    <div class="mdl-grid">
                        ...
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                        <a href="login"><span class="login-name text-color--white">Iniciar de Sesion</span></a>
                            
                        
                        {{-- <button type="submit" class="mdl-button mdl-js-button mdl-button--raised color--light-blue"  onclick = "this.form.action = 'login'" formmethod="GET">
                                {{ __('Iniciar sesion') }}
                            </button> --}}
