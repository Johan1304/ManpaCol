...
<div class="mdl-card mdl-shadow--2dp">
        <div class="box-header">
            <h3 class="box-title"> &nbsp&nbsp Salida Material</h3>

       
            <div class="mdl-grid">
                    <div class="mdl-card__supporting-text">
                    <form  class="form" action="{{route('reporteS')}}">
                    @csrf
                    ...
                    <td class="mdl-data-table__cell--non-numeric" WIDTH="100" HEIGHT="50">
                            ...
                            <input class="mdl-textfield__input" value="{{$tipo}}" type="text" id="tipo" name="tipo" readonly tabIndex="-1"/>
                                    ...
                                    <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu dark_dropdown" for="tipo">
                                            ...
                                            <li class="mdl-menu__item">Empleado</li>
                                            <li class="mdl-menu__item">Encargado</li>
        ...
        <div class="mdl-card__supporting-text no-padding">
                ...
                <table class="mdl-data-table mdl-js-data-table bordered-table  stripped-table">
                        <thead class="mdl-data-table mdl-js-data-table borderless-table">
                            <tr>
                                <th class="mdl-data-table__cell--non-numeric">id Salida</th>
                                <th class="mdl-data-table__cell--non-numeric">Nombre del empleado</th>
                                <th class="mdl-data-table__cell--non-numeric">Nombre del encargado</th>
                                <th class="mdl-data-table__cell--non-numeric">Material</th>
                                <th class="mdl-data-table__cell--non-numeric">Proveedor</th>
                                <th class="mdl-data-table__cell--non-numeric">Cantidad</th>
                                <th class="mdl-data-table__cell--non-numeric">Fecha de salida</th>
                        ...
                        <tbody>
                           ...
                           <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric">{{$material->Nombres}}</td>
                    ...
                    <div class="container">
                            <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-9 col-md-9 col-lg-9 "> {{ $salida->appends(['tipo' => $tipo, 'buscar' => $buscar])->links() }}</div>
                                </div>
