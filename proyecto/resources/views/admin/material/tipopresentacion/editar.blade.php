...
<head>
    ...
    <title>@yield('titulo','Editar TIpo Presentacion') | ManpaCol</title>
    ...
    <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-card mdl-shadow--2dp employer-form" action="">
            <div class="mdl-card__title">
                <h2>Editar Tipo Presentacion</h2>
                <div class="mdl-card__subtitle"></div>
            </div>

            <div class="mdl-card__supporting-text">
            <form action="{{route('actualizar_tipopr',['id'=>$tipop->id])}}" id="form-general" class="form" method='POST'>
                @method('PUT')
                @csrf 
                <div class="form__article">
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <div class="col-lg-8">
                              <input class="mdl-textfield__input" type="text" name="Descripcion" value="{{old('Descripcion', $tipop->Descripcion ?? '')}}" pattern="[a-z]{1,45}"/>
                            </div>
                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" type="text" name="Cantidad" value="{{old('Cantidad', $tipop->Cantidad ?? '')}}" pattern="[0-9]{1,3}"/>
                            <label class="mdl-textfield__label" for="firstName" requerido>Cantidad</label>
                        </div>
                        <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" name="UnidadMedida" value="{{old('UnidadMedida', $tipop->UnidadMedida ?? '')}}" pattern="[a-zA-Z]{1,7}"/>
