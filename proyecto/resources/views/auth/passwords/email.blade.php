        ...
        <div class="mdl-card__supporting-text color--dark-gray">
            <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                    ...
                    <input id="email" type="email" class="mdl-textfield__input form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
